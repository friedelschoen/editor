...
func TestImg09Visible(t *testing.T) {
	...
	o := d.RangeVisibleOffset(r.Max(), 0, RAlignAuto)
	d.SetRuneOffset(o)
...
func TestImg10Visible(t *testing.T) {
	...
	o := d.RangeVisibleOffset(19, 4, RAlignAuto) // line with 4's
	d.SetRuneOffset(o)
...
func TestImg11Visible(t *testing.T) {
	...
	o := d.RangeVisibleOffset(19, 7, RAlignAuto) // line with 4's
	d.SetRuneOffset(o)
...
func TestImg13Cursor(t *testing.T) {
	...
	u := d.RangeVisibleOffset(c, 1, RAlignAuto)
	d.SetRuneOffset(u)
...
func TestImg15Visible(t *testing.T) {
	...
	o := d.RangeVisibleOffset(0, 0, RAlignAuto)
	d.SetRuneOffset(o)
